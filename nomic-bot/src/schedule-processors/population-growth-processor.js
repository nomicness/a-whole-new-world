...
const populationGrowthProcessor = {
    ...
    processPlayerGrowth: function (player) {
        ...
        const populationCount = populationGrowthProcessor.getTotalPopulation(player), newPopulationCount = populationGrowthProcessor.growthFunction(populationCount, player.village.hunger), populationGrowth = newPopulationCount - populationCount;
