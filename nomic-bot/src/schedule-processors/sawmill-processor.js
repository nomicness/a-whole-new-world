(function () {
    ...
    var schedule = require('node-schedule'),
        ...
        sawmillProcessor = {
            ...
            getActiveSawmills: function (player, sawmillCount) {
                var sawmills = sawmillCount || _.get(player, 'village.sawmills', 0),
                    loggers = _.get(player, 'village.population.logging', 0);
            ...
            processSawmillProduction: function (player, mills) {
                var activeMills = sawmillProcessor.getActiveSawmills(player, mills),
                    production = _.sum(_.times(activeMills, _.partial(rollProcessor.sum, sawmillProcessor.sawmillProduction, {}))),
                    currentLumber = _.get(player, 'village.lumber', 0);
    ...
    module.exports = sawmillProcessor;
