...
const buyProcessor = {
    ...
    processBuy: function (commentsUrl, userLogin, requestBody) {
        let comment = requestBody.comment.body, result;
    ...
    sawmill: function (commentsUrl, requestBody, playerData, player) {
        let purchaseInstruction = buyProcessor.expressions.sawmill.exec(requestBody.comment.body), count = Number(purchaseInstruction[1]) || 1, pointCost = count * buyProcessor.costs.sawmill, production = 0, message = '';
    ...
    farm: function (commentsUrl, requestBody, playerData, player) {
        let purchaseInstruction = buyProcessor.expressions.farm.exec(requestBody.comment.body), farmCount = Number(purchaseInstruction[1]) || 1, pointCost = farmCount * buyProcessor.costs.farm, production = 0, message = '';
