...
const githubAuth = process.env.GITHUB_AUTH, testing = process.env.TESTING || false, logReads = process.env.LOG_READS || false;

function processResponse(deferred, request, response) {
    let body = '', size = response.headers['content-length'];
