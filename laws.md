...
**32 (n + 1).** A player may only become active upon submitting a rule in any form or a majority vote of the then active players. Given a tie vote the player is to be immediately add as active in the spirit of furthering the game.